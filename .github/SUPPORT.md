# Getting help with mmir

Thanks for using mmir. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/mmir/issues) to make sure the 
